						...
						<div class="row">
							...
							if(isset($categor)){
								if($categor=="cat"){
									...
									if($categor=="lap"){
										$resultado =  mysqli_query($connect,"SELECT * FROM productos where Categoria='Laptops'");
									}else{
										if($categor=="cel"){
										$resultado =  mysqli_query($connect,"SELECT * FROM productos where Categoria='Smartphones'");
										}else{
											if($categor=="tab"){
												$resultado =  mysqli_query($connect,"SELECT * FROM productos where Categoria='Tablets'");
											}else{
												if($categor=="acc"){
												$resultado =  mysqli_query($connect,"SELECT * FROM productos where Categoria='Accesorios'");
												}	
											}
										}
									}
